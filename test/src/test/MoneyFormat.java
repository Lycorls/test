 ...
 * 把金额转换成汉字大写金额
 * @author hefan
 * @date 创建时间：2017年1月23日 上午9:52:28
 *
 */
class MoneyFormat {
	private final static String[] pattern = { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒",
			"捌", "玖" };
	private final static String[] cPattern = { "", "拾", "佰", "仟", "万", "拾", "佰", "仟",
			"亿" };
	...
	public static void main(String[] ar) {
		System.out.println(MoneyFormat.format("10005022.123009"));
		System.out.println(MoneyFormat.format("0.12"));
//		System.out.println(new MoneyFormat().format("10005022.123009"));
//		System.out.println(new MoneyFormat().format("0.12"));
	}
}
